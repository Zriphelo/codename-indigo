...
const TransferForm = () => {
  ...
  return (
    <div className="grid grid-cols-2">
      ...
      <Display className="hidden sm:block" title="Tokens to send: ">
        <form onSubmit={handleSubmit}>
          <input
            className="rounded-xl p-1 px-3 my-2 text-slate-900 bg-slate-100/40 border w-full"
            type="text"
            value={amount}
      ...
      <Display className="hidden sm:block" title="Target address: ">
        <input
          className="rounded-xl p-1 px-3 my-2 text-slate-900 bg-slate-100/40 border w-full items-center"
          type="text"
          value={targetAddress}
      ...
      <Display title="Tokens to send: ">
        <form onSubmit={handleSubmit}>
          <input
            className="rounded-xl p-1 px-3 mt-2 text-slate-900 bg-slate-100/40 border w-full"
            type="text"
            value={amount}
            onChange={handleChange}
          />{" "}
      ...
      <Display title="Target address: ">
        <input
          className="rounded-xl p-1 px-3 mt-2 text-slate-900 bg-slate-100/40 border w-full items-center"
          type="text"
          value={targetAddress}
          onChange={handleToChange}
        />
    ...
    return (
      <div className="flex lg:mx-10 lg:px-4 justify-center">
        <Display title="Access unauthorized">
          {isConnected
            ? "You need to use Goerli testnet network"
